      ...
      const sampleTips = [
        {
          ...
          content:
            'Colonists get a mood debuff when eating without a table. Always build dining areas!',
          category: 'Mood',
          difficulty: 'Beginner',
        },
        {
        ...
        },
        {
          ...
          content:
            'Focus on researching electricity and air conditioning early for better quality of life.',
          category: 'Research',
          difficulty: 'Beginner',
        },
      ]
